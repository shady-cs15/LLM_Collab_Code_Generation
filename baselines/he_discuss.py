...
class QwenHumanEvalTwoRoundEvaluator:
    def __init__(self, aux_model_name, main_model_name, device="auto"):
        """
        Initialize the two-round model evaluator for HumanEval.
...
"""
    ...
    def evaluate_two_round_completion(
        ...
        """
        Evaluate a two-round model completion using the humaneval reward logger approach.
        """
        metrics = {
            "sample_id": sample_id,
    ...
    def evaluate_humaneval_two_round(
        self,
        num_samples: int = 31,
        ...
        """
        Evaluate HumanEval two-round model system on the last num_samples.
        """
        ...
        if save_results:
            ...
            filename = f"humaneval_two_round_{int(time.time())}.json"
...
if __name__ == "__main__":
    # python experiments/evaluation/he_discuss.py --generations 15 --k-values 1 3 5 10
    main()
