...
def plot_combined_three_panels():
    ...
    ax2.set_title("CHE | Turn 1", fontsize=title_size, pad=10)
    ...
    ax3.set_title("CHE | Turn 2", fontsize=title_size, pad=10)
    ...
    timestamp = time.time()
    plt.savefig(f"./che_all_{timestamp}.pdf", dpi=300)
    ...
    legend = fig_legend.legend(
        ...
        handlelength=2,  # Set to 2 as requested
        title="Metrics",
        title_fontsize=24,
    ...
    fig_legend.savefig(
        f"./che_legend_{timestamp}.pdf", dpi=300, bbox_inches="tight", pad_inches=0.1
    )
    ...
    with open(f"./che_all_{timestamp}.pdf", "rb") as file:
        ...
        with open(f"./che_{timestamp}.pdf", "wb") as left_file:
            left_writer.write(left_file)

        with open(f"./mt_che_{timestamp}.pdf", "wb") as right_file:
