...
def arxiv_single_formatter(example: Dict[str, Any]) -> str:
    ...
    # IMPORTANT INSTRUCTIONS:
    # - Provide a comprehensive introduction covering background, motivation, methodology, and implications
...
def tldr_single_formatter(example: Dict[str, Any]) -> str:
    ...
    #     prompt_text = f"""Create a comprehensive summary response to this post.

    # Query:
    # {prompt}

    # IMPORTANT INSTRUCTIONS:
    # - Provide a complete and informative summary
    # - Be both concise and detailed where appropriate
